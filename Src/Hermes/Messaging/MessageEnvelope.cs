...
namespace Hermes.Messaging
{
    ...
    public class MessageEnvelope 
    {
        ...
        [IgnoreDataMember]
        private readonly static MessageEnvelope undefined = new MessageEnvelope(Guid.Empty, Guid.Empty, TimeSpan.MinValue, false, new Dictionary<string, string>(0), new byte[0]);
