    ...
    class ServiceHost
    {
        ...
        private void RunServices()
        {
            ...
            try
            {
                ...
                var service = (IEndpoint)ObjectFactory.CreateInstance(serviceType);
                Task.Factory.StartNew(() => service.Start(tokenSource.Token), tokenSource.Token, TaskCreationOptions.LongRunning, TaskScheduler.Current);
            }
            catch
            {
                tokenSource.Cancel();
